...
export const AdminLayout = ({routes = [], links = [], dropDownMenus = [], headerMenuItems = [], getComponent, appConfig, ...rest}) => (
    <div className="app">
        <Header {...appConfig} dropDownMenus={dropDownMenus} menuItems={headerMenuItems}/>
